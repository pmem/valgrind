...
int main ( void )
{
    ...
    VALGRIND_PMC_REGISTER_PMEM_MAPPING(0, 0x110, 0x10);
    VALGRIND_PMC_REGISTER_PMEM_MAPPING(0, 0x120, 0x10);
    ...
    VALGRIND_PMC_REGISTER_PMEM_MAPPING(0, 0x140, 0x60);
    /* remove region within the mapping */
    VALGRIND_PMC_REMOVE_PMEM_MAPPING(0x150, 0x10);
    VALGRIND_PMC_PRINT_PMEM_MAPPINGS;

    VALGRIND_PMC_REGISTER_PMEM_MAPPING(0, 0x200, 0x60);
